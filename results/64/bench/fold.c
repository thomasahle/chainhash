...
CH_T512 __attribute__((noinline)) static uint64_t extracts(const __m512i *p,size_t n) {
...
CH_T512 __attribute__((noinline)) static uint64_t butterfly(const __m512i *p,size_t n) {
    __m128i sum=_mm_setzero_si128(); size_t i;
