...
REGISTER_HASH(chainhash, $.desc="ChainHash: comb CLNH blocks, Horner chain over GF(2^64), twisted quintic finalizer", $.impl="lazy-k4", $.hash_flags=FLAG_HASH_CLMUL_BASED, $.impl_flags=FLAG_IMPL_LICENSE_MIT, $.bits=64, $.verification_LE=0x66672BD6, $.verification_BE=0xFA8A8D3B, $.seedfn=chainhash_seed, $.hashfn_native=chainhash_hash<false>, $.hashfn_bswap=chainhash_hash<true>);
