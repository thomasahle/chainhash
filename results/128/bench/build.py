...
files=sorted((root/'benchmarks').glob('chainhash128*.cpp'))+[root/'benchmarks/control64.cpp',root/'benchmarks/control128.cpp']
objects=[]
for f in files:
