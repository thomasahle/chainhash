...
p=argparse.ArgumentParser();p.add_argument('binary',type=pathlib.Path);p.add_argument('out',type=pathlib.Path);p.add_argument('--passes',type=int);p.add_argument('--names',nargs='+',default=['chainhash-128','chainhash-128.256karatsuba','chainhash-128.256schoolbook','chainhash-128.karatsuba','chainhash-128.schoolbook','XXH3-128','UMASH-128','komihash','rapidhash','chainhash','control-128']);a=p.parse_args()
