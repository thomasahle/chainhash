...
__attribute__((noinline)) static uint64_t call(int f,const void *k,const void *p,size_t n) {if(f)return chainhash_v3((const chainhash_v3_key *)k,p,n);return chainhash128((const chainhash128_key *)k,p,n).lo;}
