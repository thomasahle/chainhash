...
export LEAN_NUM_THREADS=32
{
  ...
  sha256sum ./*.lean ProvenHashes/*.lean vectors/*.lean ./*.py verify.sh PROVENANCE.json SOURCE_HEADS.txt ../test/lean_vectors_v3.c ../include/chainhash3.h lakefile.toml lake-manifest.json lean-toolchain
  lake --version
