...
theorem residue_step_77 : residue_77 ^ 2 = residue_78 + modulus * (sparse [2, 6, 10, 12, 20, 22, 26, 34, 38, 44, 46, 48, 60, 62, 68, 72, 80, 82, 96, 98, 100, 102, 110, 116, 118, 120]) := by
  unfold residue_77 residue_78 modulus
