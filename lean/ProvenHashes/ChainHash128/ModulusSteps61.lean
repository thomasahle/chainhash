...
theorem residue_step_61 : residue_61 ^ 2 = residue_62 + modulus * (sparse [0, 2, 4, 5, 8, 12, 16, 18, 30, 32, 38, 46, 48, 50, 54, 56, 58, 64, 68, 70, 72, 74, 76, 78, 88, 90, 92, 94, 98, 100, 104, 108, 110, 114, 116, 118, 120, 126]) := by
