...
theorem residue_step_118 : residue_118 ^ 2 = residue_119 + modulus * (sparse [0, 1, 2, 8, 10, 16, 18, 20, 22, 32, 34, 38, 46, 52, 58, 60, 64, 66, 68, 76, 96, 98, 104, 110, 120, 122]) := by
  unfold residue_118 residue_119 modulus
