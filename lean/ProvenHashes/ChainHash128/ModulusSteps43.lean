...
theorem residue_step_43 : residue_43 ^ 2 = residue_44 + modulus * (sparse [0, 1, 2, 3, 4, 5, 6, 20, 24, 32, 38, 40, 42, 46, 50, 54, 56, 58, 60, 64, 70, 72, 76, 80, 82, 84, 90, 94, 96, 98, 100, 104, 108, 110, 114, 116, 118, 122, 124, 126]) := by
