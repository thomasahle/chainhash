...
theorem residue_step_86 : residue_86 ^ 2 = residue_87 + modulus * (sparse [0, 1, 4, 6, 8, 18, 20, 28, 30, 32, 38, 44, 46, 58, 62, 64, 72, 76, 84, 90, 92, 98, 100, 106, 118, 122]) := by
  unfold residue_86 residue_87 modulus
