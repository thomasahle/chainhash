...
theorem residue_step_65 : residue_65 ^ 2 = residue_66 + modulus * (sparse [0, 1, 2, 3, 12, 14, 16, 18, 22, 28, 30, 44, 48, 52, 54, 58, 60, 62, 66, 68, 74, 76, 78, 88, 90, 96, 100, 102, 104, 110, 116, 118, 120, 122, 124]) := by
  unfold residue_65 residue_66 modulus
