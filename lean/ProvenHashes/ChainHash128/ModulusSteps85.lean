...
theorem residue_step_85 : residue_85 ^ 2 = residue_86 + modulus * (sparse [2, 3, 4, 5, 6, 10, 12, 14, 20, 24, 26, 30, 32, 34, 38, 40, 54, 56, 58, 60, 64, 70, 72, 76, 86, 94, 100, 106, 108, 114, 116, 120, 124, 126]) := by
  unfold residue_85 residue_86 modulus
