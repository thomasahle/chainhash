...
theorem residue_step_89 : residue_89 ^ 2 = residue_90 + modulus * (sparse [0, 2, 3, 4, 8, 10, 16, 18, 20, 24, 28, 30, 36, 38, 40, 42, 44, 50, 54, 60, 62, 68, 70, 72, 74, 76, 90, 94, 100, 104, 106, 108, 112, 116, 120, 124]) := by
  unfold residue_89 residue_90 modulus
