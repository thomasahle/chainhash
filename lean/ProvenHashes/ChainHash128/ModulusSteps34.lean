...
theorem residue_step_34 : residue_34 ^ 2 = residue_35 + modulus * (sparse [2, 3, 4, 5, 6, 8, 12, 18, 22, 24, 28, 34, 40, 48, 54, 64, 68, 70, 72, 76, 78, 82, 88, 90, 94, 96, 104, 108, 110, 114, 118, 124, 126]) := by
