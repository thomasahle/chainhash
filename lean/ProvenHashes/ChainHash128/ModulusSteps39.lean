...
theorem residue_step_39 : residue_39 ^ 2 = residue_40 + modulus * (sparse [0, 2, 3, 5, 10, 14, 18, 24, 30, 32, 36, 46, 52, 54, 56, 58, 60, 62, 68, 70, 72, 76, 82, 84, 86, 90, 94, 98, 100, 102, 104, 106, 108, 110, 112, 114, 116, 118, 120, 124, 126]) := by
