...
theorem residue_step_30 : residue_30 ^ 2 = residue_31 + modulus * (sparse [2, 3, 4, 5, 10, 12, 22, 26, 32, 34, 36, 38, 44, 46, 50, 60, 64, 66, 72, 74, 76, 80, 82, 84, 90, 94, 96, 104, 106, 112, 114, 120, 124, 126]) := by
