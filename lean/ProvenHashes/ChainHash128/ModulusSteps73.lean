...
theorem residue_step_73 : residue_73 ^ 2 = residue_74 + modulus * (sparse [0, 3, 4, 5, 6, 12, 16, 18, 20, 22, 24, 26, 28, 30, 32, 34, 36, 38, 40, 42, 44, 48, 50, 54, 56, 58, 64, 66, 68, 72, 74, 80, 82, 98, 100, 104, 106, 110, 114, 116, 124, 126]) := by
  unfold residue_73 residue_74 modulus
