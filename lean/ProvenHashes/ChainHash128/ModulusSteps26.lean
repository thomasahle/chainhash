...
theorem residue_step_26 : residue_26 ^ 2 = residue_27 + modulus * (sparse [0, 1, 4, 6, 16, 20, 24, 26, 32, 42, 44, 50, 52, 64, 68, 70, 72, 74, 86, 88, 92, 94, 96, 98, 102, 104, 106, 116, 118, 122]) := by
