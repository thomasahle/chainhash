...
theorem residue_step_68 : residue_68 ^ 2 = residue_69 + modulus * (sparse [1, 5, 6, 8, 10, 12, 14, 20, 22, 24, 26, 28, 30, 40, 56, 58, 60, 62, 64, 72, 78, 84, 92, 102, 110, 112, 114, 116, 118, 120, 122, 126]) := by
  unfold residue_68 residue_69 modulus
