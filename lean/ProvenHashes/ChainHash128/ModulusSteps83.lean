...
theorem residue_step_83 : residue_83 ^ 2 = residue_84 + modulus * (sparse [0, 2, 4, 16, 18, 24, 26, 30, 32, 36, 38, 44, 52, 54, 58, 60, 64, 72, 74, 78, 80, 84, 90, 96, 100, 106, 112, 116]) := by
  unfold residue_83 residue_84 modulus
