...
theorem residue_step_97 : residue_97 ^ 2 = residue_98 + modulus * (sparse [0, 1, 2, 6, 8, 12, 14, 24, 26, 28, 30, 32, 34, 40, 48, 54, 64, 68, 72, 74, 76, 82, 86, 90, 92, 94, 96, 98, 102, 104, 106, 108, 112, 122]) := by
  unfold residue_97 residue_98 modulus
