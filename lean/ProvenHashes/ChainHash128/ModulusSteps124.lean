...
theorem residue_step_124 : residue_124 ^ 2 = residue_125 + modulus * (sparse [3, 4, 5, 8, 10, 12, 18, 20, 22, 24, 30, 36, 42, 54, 64, 66, 76, 78, 80, 88, 90, 92, 100, 102, 104, 112, 114, 116, 124, 126]) := by
  unfold residue_124 residue_125 modulus
