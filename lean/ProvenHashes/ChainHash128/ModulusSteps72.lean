...
theorem residue_step_72 : residue_72 ^ 2 = residue_73 + modulus * (sparse [0, 3, 4, 5, 8, 10, 12, 14, 16, 18, 24, 32, 34, 38, 44, 50, 52, 54, 58, 60, 62, 64, 68, 70, 72, 80, 82, 84, 86, 96, 100, 102, 104, 106, 108, 110, 114, 118, 124, 126]) := by
  unfold residue_72 residue_73 modulus
