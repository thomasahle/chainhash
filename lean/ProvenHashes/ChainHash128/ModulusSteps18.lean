...
theorem residue_step_18 : residue_18 ^ 2 = residue_19 + modulus * (sparse [5, 16, 20, 26, 28, 32, 36, 38, 42, 48, 56, 58, 64, 66, 70, 72, 78, 88, 92, 96, 102, 106, 108, 112, 114, 118, 126]) := by
