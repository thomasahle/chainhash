...
def decodeKey {F : Type*} [AddGroup F] (repr : Word 128 ≃+ F) (k : Key41) : IdealKey F :=
...
def encodeKey {F : Type*} [AddGroup F] (repr : Word 128 ≃+ F) (k : IdealKey F) : Key41 :=
...
def keyEquiv {F : Type*} [AddGroup F] (repr : Word 128 ≃+ F) : Key41 ≃ IdealKey F where
