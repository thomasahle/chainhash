...
theorem residue_step_94 : residue_94 ^ 2 = residue_95 + modulus * (sparse [2, 4, 5, 10, 12, 20, 22, 24, 26, 28, 30, 38, 40, 42, 44, 52, 54, 64, 68, 70, 82, 90, 96, 100, 106, 108, 112, 114, 116, 118, 120, 126]) := by
  unfold residue_94 residue_95 modulus
