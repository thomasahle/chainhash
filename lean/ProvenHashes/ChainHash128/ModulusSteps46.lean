...
theorem residue_step_46 : residue_46 ^ 2 = residue_47 + modulus * (sparse [1, 2, 3, 4, 12, 16, 22, 24, 30, 32, 34, 38, 40, 42, 46, 48, 54, 56, 62, 66, 68, 70, 72, 74, 80, 86, 98, 102, 112, 120, 122, 124]) := by
