...
theorem residue_step_44 : residue_44 ^ 2 = residue_45 + modulus * (sparse [3, 5, 6, 12, 18, 20, 24, 30, 32, 34, 42, 46, 50, 52, 56, 60, 62, 64, 70, 72, 76, 78, 80, 84, 86, 88, 90, 92, 110, 112, 114, 120, 124, 126]) := by
