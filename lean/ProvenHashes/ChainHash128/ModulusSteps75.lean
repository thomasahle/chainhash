...
theorem residue_step_75 : residue_75 ^ 2 = residue_76 + modulus * (sparse [3, 8, 10, 14, 18, 28, 30, 34, 38, 42, 44, 54, 60, 64, 66, 70, 72, 76, 80, 82, 92, 98, 104, 116, 118, 120, 124]) := by
  unfold residue_75 residue_76 modulus
