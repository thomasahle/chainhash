...
theorem residue_step_42 : residue_42 ^ 2 = residue_43 + modulus * (sparse [2, 3, 5, 8, 10, 14, 20, 22, 28, 32, 34, 40, 42, 46, 48, 52, 56, 58, 60, 82, 84, 86, 98, 108, 110, 112, 114, 116, 124, 126]) := by
