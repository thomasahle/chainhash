...
theorem residue_step_35 : residue_35 ^ 2 = residue_36 + modulus * (sparse [2, 3, 4, 5, 10, 18, 20, 22, 40, 42, 44, 52, 54, 60, 74, 76, 78, 80, 82, 84, 88, 90, 96, 100, 104, 106, 108, 110, 112, 114, 120, 124, 126]) := by
