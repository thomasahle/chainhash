...
theorem residue_step_62 : residue_62 ^ 2 = residue_63 + modulus * (sparse [0, 1, 4, 8, 10, 12, 16, 18, 20, 24, 28, 32, 34, 36, 38, 40, 42, 50, 52, 54, 56, 58, 60, 64, 66, 72, 84, 86, 90, 92, 100, 104, 108, 110, 112, 116, 118, 120, 122]) := by
