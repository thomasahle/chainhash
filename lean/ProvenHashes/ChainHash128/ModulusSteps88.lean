...
theorem residue_step_88 : residue_88 ^ 2 = residue_89 + modulus * (sparse [4, 5, 6, 10, 14, 16, 18, 26, 28, 42, 44, 46, 50, 54, 56, 58, 68, 72, 74, 80, 82, 84, 86, 92, 94, 108, 110, 114, 120, 126]) := by
  unfold residue_88 residue_89 modulus
