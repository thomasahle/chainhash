...
theorem residue_step_66 : residue_66 ^ 2 = residue_67 + modulus * (sparse [2, 3, 5, 8, 12, 18, 20, 24, 26, 28, 30, 32, 34, 36, 38, 42, 50, 54, 56, 60, 62, 64, 72, 74, 82, 84, 86, 88, 90, 92, 96, 100, 108, 110, 114, 124, 126]) := by
  unfold residue_66 residue_67 modulus
