...
theorem residue_step_81 : residue_81 ^ 2 = residue_82 + modulus * (sparse [2, 3, 5, 6, 8, 10, 16, 22, 28, 30, 42, 44, 46, 48, 50, 52, 54, 56, 58, 60, 66, 68, 72, 74, 76, 78, 82, 86, 88, 92, 94, 100, 104, 106, 108, 114, 118, 124, 126]) := by
  unfold residue_81 residue_82 modulus
