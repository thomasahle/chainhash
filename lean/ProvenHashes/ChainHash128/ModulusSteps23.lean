...
theorem residue_step_23 : residue_23 ^ 2 = residue_24 + modulus * (sparse [2, 4, 5, 6, 8, 12, 14, 16, 20, 22, 24, 26, 30, 34, 46, 48, 52, 56, 62, 66, 68, 72, 74, 76, 78, 80, 88, 94, 96, 100, 102, 106, 110, 112, 114, 126]) := by
