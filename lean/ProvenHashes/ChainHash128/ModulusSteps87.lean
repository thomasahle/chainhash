...
theorem residue_step_87 : residue_87 ^ 2 = residue_88 + modulus * (sparse [1, 3, 4, 8, 10, 12, 14, 16, 18, 24, 26, 28, 30, 38, 40, 42, 44, 58, 64, 66, 68, 74, 76, 80, 82, 84, 92, 98, 100, 110, 116, 118, 120, 122, 124]) := by
  unfold residue_87 residue_88 modulus
