...
theorem residue_step_38 : residue_38 ^ 2 = residue_39 + modulus * (sparse [0, 1, 2, 3, 5, 10, 12, 14, 16, 18, 20, 22, 26, 42, 46, 54, 56, 58, 62, 70, 72, 76, 82, 86, 88, 90, 96, 98, 102, 106, 110, 114, 118, 122, 124, 126]) := by
