...
theorem residue_step_29 : residue_29 ^ 2 = residue_30 + modulus * (sparse [0, 2, 3, 5, 6, 14, 18, 26, 32, 36, 38, 42, 48, 50, 52, 60, 62, 64, 66, 70, 72, 74, 78, 82, 84, 86, 90, 92, 98, 100, 106, 108, 110, 112, 114, 118, 124, 126]) := by
