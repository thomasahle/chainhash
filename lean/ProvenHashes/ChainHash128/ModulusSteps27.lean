...
theorem residue_step_27 : residue_27 ^ 2 = residue_28 + modulus * (sparse [1, 2, 8, 10, 18, 24, 26, 28, 30, 32, 34, 36, 44, 46, 48, 50, 56, 60, 64, 66, 74, 84, 86, 88, 90, 92, 94, 98, 100, 104, 106, 108, 110, 116, 122]) := by
