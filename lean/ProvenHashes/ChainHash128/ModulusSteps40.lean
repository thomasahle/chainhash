...
theorem residue_step_40 : residue_40 ^ 2 = residue_41 + modulus * (sparse [2, 4, 6, 14, 18, 20, 22, 24, 28, 30, 36, 40, 42, 44, 46, 50, 52, 56, 58, 62, 64, 66, 70, 78, 84, 88, 92, 100, 104, 108, 118, 120]) := by
