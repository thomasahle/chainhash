...
theorem residue_step_54 : residue_54 ^ 2 = residue_55 + modulus * (sparse [1, 2, 4, 6, 8, 10, 14, 16, 18, 24, 26, 30, 34, 40, 46, 48, 50, 52, 60, 62, 68, 74, 78, 84, 88, 102, 104, 108, 116, 118, 120, 122]) := by
  unfold residue_54 residue_55 modulus
