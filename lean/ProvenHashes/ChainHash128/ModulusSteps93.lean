...
theorem residue_step_93 : residue_93 ^ 2 = residue_94 + modulus * (sparse [4, 5, 6, 12, 20, 26, 28, 34, 36, 38, 42, 44, 46, 52, 54, 58, 60, 66, 68, 72, 76, 84, 98, 108, 114, 116, 126]) := by
  unfold residue_93 residue_94 modulus
