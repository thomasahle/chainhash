...
theorem residue_step_78 : residue_78 ^ 2 = residue_79 + modulus * (sparse [1, 5, 6, 8, 12, 16, 18, 20, 22, 30, 32, 34, 38, 40, 44, 46, 48, 50, 52, 66, 70, 74, 82, 86, 88, 90, 92, 94, 100, 104, 110, 114, 118, 122, 126]) := by
  unfold residue_78 residue_79 modulus
