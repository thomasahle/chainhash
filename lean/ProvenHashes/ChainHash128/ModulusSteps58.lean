...
theorem residue_step_58 : residue_58 ^ 2 = residue_59 + modulus * (sparse [0, 10, 14, 18, 20, 30, 32, 34, 36, 38, 46, 50, 60, 68, 72, 74, 76, 80, 82, 84, 90, 92, 94, 100, 106, 110, 116, 120]) := by
