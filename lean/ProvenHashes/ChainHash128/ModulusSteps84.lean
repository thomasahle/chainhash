...
theorem residue_step_84 : residue_84 ^ 2 = residue_85 + modulus * (sparse [0, 3, 6, 8, 14, 16, 18, 22, 24, 28, 46, 52, 60, 64, 68, 74, 76, 78, 84, 92, 106, 110, 112, 118, 120, 124]) := by
  unfold residue_84 residue_85 modulus
