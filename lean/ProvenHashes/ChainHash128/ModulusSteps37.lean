...
theorem residue_step_37 : residue_37 ^ 2 = residue_38 + modulus * (sparse [2, 4, 6, 10, 14, 20, 22, 26, 30, 32, 34, 40, 42, 44, 50, 54, 56, 60, 64, 66, 68, 76, 82, 84, 86, 88, 98, 106, 108, 116, 118, 120]) := by
