...
theorem residue_step_51 : residue_51 ^ 2 = residue_52 + modulus * (sparse [0, 2, 3, 4, 8, 10, 12, 14, 20, 30, 36, 40, 42, 46, 50, 52, 54, 58, 60, 62, 64, 70, 74, 84, 86, 94, 96, 100, 104, 106, 108, 112, 116, 118, 124]) := by
  unfold residue_51 residue_52 modulus
