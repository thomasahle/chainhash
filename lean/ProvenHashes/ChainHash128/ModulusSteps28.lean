...
theorem residue_step_28 : residue_28 ^ 2 = residue_29 + modulus * (sparse [2, 14, 16, 18, 20, 22, 24, 28, 32, 34, 40, 42, 44, 46, 50, 52, 56, 64, 66, 76, 84, 88, 90, 98, 100, 102, 112, 116, 120]) := by
