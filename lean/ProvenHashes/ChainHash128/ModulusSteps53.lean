...
theorem residue_step_53 : residue_53 ^ 2 = residue_54 + modulus * (sparse [1, 2, 3, 4, 8, 10, 20, 24, 26, 44, 48, 50, 52, 60, 62, 64, 72, 76, 80, 82, 94, 102, 108, 122, 124]) := by
  unfold residue_53 residue_54 modulus
