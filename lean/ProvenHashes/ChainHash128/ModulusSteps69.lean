...
theorem residue_step_69 : residue_69 ^ 2 = residue_70 + modulus * (sparse [0, 1, 3, 6, 10, 12, 14, 16, 18, 20, 28, 32, 44, 52, 54, 58, 60, 68, 70, 76, 78, 80, 88, 90, 92, 94, 96, 98, 100, 102, 108, 116, 120, 122, 124]) := by
  unfold residue_69 residue_70 modulus
