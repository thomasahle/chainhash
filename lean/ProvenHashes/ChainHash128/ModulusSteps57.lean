...
theorem residue_step_57 : residue_57 ^ 2 = residue_58 + modulus * (sparse [0, 1, 2, 5, 14, 16, 18, 20, 26, 28, 36, 40, 56, 58, 62, 64, 72, 80, 82, 100, 104, 106, 108, 112, 114, 116, 120, 122, 126]) := by
