...
theorem residue_step_31 : residue_31 ^ 2 = residue_32 + modulus * (sparse [1, 2, 3, 8, 14, 20, 22, 24, 26, 28, 30, 32, 40, 42, 44, 46, 50, 56, 60, 62, 68, 74, 76, 78, 82, 84, 86, 88, 92, 94, 100, 102, 104, 108, 110, 122, 124]) := by
