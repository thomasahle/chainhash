...
theorem residue_step_91 : residue_91 ^ 2 = residue_92 + modulus * (sparse [1, 2, 6, 14, 18, 22, 26, 34, 36, 40, 42, 44, 46, 50, 52, 56, 62, 72, 84, 88, 90, 94, 96, 100, 102, 106, 108, 118, 120, 122]) := by
  unfold residue_91 residue_92 modulus
