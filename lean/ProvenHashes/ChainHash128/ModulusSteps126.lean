...
theorem residue_step_126 : residue_126 ^ 2 = residue_127 + modulus * (sparse [5, 10, 12, 22, 24, 34, 36, 46, 48, 58, 60, 66, 70, 72, 78, 82, 84, 90, 94, 96, 102, 106, 108, 114, 118, 120, 126]) := by
  unfold residue_126 residue_127 modulus
