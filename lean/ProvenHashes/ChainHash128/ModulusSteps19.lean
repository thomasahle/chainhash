...
theorem residue_step_19 : residue_19 ^ 2 = residue_20 + modulus * (sparse [0, 1, 5, 6, 8, 12, 16, 20, 26, 28, 32, 36, 40, 42, 44, 48, 50, 52, 56, 58, 62, 66, 68, 70, 76, 80, 86, 88, 92, 96, 100, 104, 112, 114, 116, 120, 122, 126]) := by
