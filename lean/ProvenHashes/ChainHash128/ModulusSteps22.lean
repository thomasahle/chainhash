...
theorem residue_step_22 : residue_22 ^ 2 = residue_23 + modulus * (sparse [2, 5, 8, 14, 16, 18, 20, 24, 28, 34, 38, 40, 44, 46, 50, 52, 54, 56, 62, 64, 66, 68, 72, 76, 80, 82, 88, 96, 100, 106, 110, 112, 114, 126]) := by
