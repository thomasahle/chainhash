...
theorem residue_step_48 : residue_48 ^ 2 = residue_49 + modulus * (sparse [0, 1, 3, 5, 6, 8, 18, 34, 40, 46, 50, 56, 58, 60, 64, 66, 68, 72, 82, 84, 88, 90, 94, 98, 100, 104, 112, 114, 122, 124, 126]) := by
  unfold residue_48 residue_49 modulus
