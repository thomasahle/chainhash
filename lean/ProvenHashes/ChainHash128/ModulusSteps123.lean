...
theorem residue_step_123 : residue_123 ^ 2 = residue_124 + modulus * (sparse [1, 2, 6, 10, 12, 14, 18, 22, 30, 34, 40, 46, 50, 52, 62, 72, 74, 80, 84, 86, 92, 96, 98, 104, 108, 110, 116, 120, 122]) := by
  unfold residue_123 residue_124 modulus
