...
theorem residue_step_76 : residue_76 ^ 2 = residue_77 + modulus * (sparse [0, 2, 3, 4, 5, 8, 12, 20, 24, 28, 30, 34, 36, 40, 44, 46, 50, 52, 58, 60, 68, 76, 80, 94, 100, 104, 106, 110, 114, 116, 118, 120, 124, 126]) := by
  unfold residue_76 residue_77 modulus
