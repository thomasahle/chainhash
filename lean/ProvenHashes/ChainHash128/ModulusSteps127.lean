...
theorem residue_step_127 : residue_127 ^ 2 = residue_128 + modulus * (sparse [1, 2, 8, 14, 20, 26, 32, 38, 44, 50, 56, 62, 68, 74, 80, 86, 92, 98, 104, 110, 116, 122]) := by
  unfold residue_127 residue_128 modulus
