...
theorem residue_step_64 : residue_64 ^ 2 = residue_65 + modulus * (sparse [0, 1, 3, 6, 8, 10, 14, 18, 24, 26, 38, 40, 44, 48, 50, 54, 58, 60, 66, 70, 74, 76, 78, 80, 82, 84, 86, 88, 96, 100, 106, 108, 112, 122, 124]) := by
  unfold residue_64 residue_65 modulus
