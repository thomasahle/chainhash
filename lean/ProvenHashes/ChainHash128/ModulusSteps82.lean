...
theorem residue_step_82 : residue_82 ^ 2 = residue_83 + modulus * (sparse [2, 5, 8, 10, 12, 16, 24, 26, 28, 34, 42, 46, 48, 52, 56, 64, 70, 72, 82, 88, 90, 92, 94, 96, 98, 104, 108, 110, 114, 120, 126]) := by
  unfold residue_82 residue_83 modulus
