...
theorem residue_step_63 : residue_63 ^ 2 = residue_64 + modulus * (sparse [1, 3, 4, 5, 14, 16, 30, 32, 42, 46, 48, 66, 68, 70, 74, 80, 82, 86, 90, 98, 100, 102, 108, 114, 116, 120, 122, 124, 126]) := by
