...
theorem residue_step_92 : residue_92 ^ 2 = residue_93 + modulus * (sparse [1, 3, 4, 5, 10, 18, 30, 36, 42, 44, 48, 50, 56, 60, 76, 80, 84, 92, 96, 98, 102, 104, 108, 110, 112, 114, 116, 118, 122, 124, 126]) := by
  unfold residue_92 residue_93 modulus
