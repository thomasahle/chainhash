...
theorem residue_step_70 : residue_70 ^ 2 = residue_71 + modulus * (sparse [0, 1, 2, 3, 4, 5, 6, 10, 12, 14, 20, 22, 24, 30, 34, 38, 40, 42, 46, 48, 50, 54, 56, 58, 60, 64, 72, 82, 86, 92, 96, 100, 102, 106, 112, 114, 116, 120, 122, 124, 126]) := by
  unfold residue_70 residue_71 modulus
