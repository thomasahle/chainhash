...
theorem residue_step_120 : residue_120 ^ 2 = residue_121 + modulus * (sparse [0, 6, 8, 10, 12, 14, 16, 20, 22, 32, 34, 38, 42, 46, 52, 56, 58, 64, 70, 74, 76, 80, 84, 90, 92, 96, 106, 118]) := by
  unfold residue_120 residue_121 modulus
