...
theorem residue_step_60 : residue_60 ^ 2 = residue_61 + modulus * (sparse [1, 2, 3, 10, 14, 16, 18, 28, 36, 38, 40, 42, 50, 54, 56, 58, 60, 66, 78, 82, 84, 86, 98, 100, 102, 104, 106, 118, 120, 122, 124]) := by
