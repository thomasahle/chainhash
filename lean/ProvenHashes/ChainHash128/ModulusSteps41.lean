...
theorem residue_step_41 : residue_41 ^ 2 = residue_42 + modulus * (sparse [0, 1, 4, 5, 6, 10, 12, 16, 18, 24, 26, 30, 40, 48, 50, 52, 54, 58, 62, 70, 74, 76, 82, 84, 86, 88, 90, 94, 96, 100, 102, 104, 108, 110, 112, 114, 116, 122, 126]) := by
