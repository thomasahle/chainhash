...
theorem residue_step_71 : residue_71 ^ 2 = residue_72 + modulus * (sparse [0, 1, 6, 12, 14, 16, 18, 20, 24, 28, 30, 36, 38, 40, 44, 46, 50, 52, 56, 60, 66, 68, 70, 74, 76, 88, 90, 92, 96, 102, 104, 106, 108, 110, 112, 120, 122]) := by
  unfold residue_71 residue_72 modulus
