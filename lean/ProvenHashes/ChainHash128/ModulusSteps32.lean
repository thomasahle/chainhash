...
theorem residue_step_32 : residue_32 ^ 2 = residue_33 + modulus * (sparse [1, 3, 6, 8, 24, 26, 30, 32, 34, 40, 44, 46, 48, 52, 54, 56, 60, 64, 70, 72, 78, 82, 86, 96, 100, 102, 106, 118, 120, 122, 124]) := by
