...
theorem residue_step_47 : residue_47 ^ 2 = residue_48 + modulus * (sparse [0, 1, 5, 6, 12, 14, 16, 26, 30, 36, 44, 56, 58, 60, 64, 70, 72, 76, 78, 80, 82, 84, 90, 92, 98, 108, 110, 112, 114, 116, 118, 122, 126]) := by
