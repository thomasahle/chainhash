...
theorem residue_step_25 : residue_25 ^ 2 = residue_26 + modulus * (sparse [0, 1, 2, 4, 5, 10, 14, 16, 22, 24, 30, 32, 36, 40, 42, 44, 48, 52, 56, 62, 66, 68, 72, 74, 76, 78, 80, 82, 86, 92, 100, 110, 112, 114, 118, 120, 122, 126]) := by
