...
theorem residue_step_98 : residue_98 ^ 2 = residue_99 + modulus * (sparse [2, 4, 10, 14, 16, 18, 24, 26, 28, 30, 34, 46, 48, 50, 52, 54, 62, 64, 68, 72, 74, 76, 84, 86, 88, 94, 100, 102, 108, 110, 118, 120]) := by
  unfold residue_98 residue_99 modulus
