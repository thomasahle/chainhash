...
theorem residue_step_95 : residue_95 ^ 2 = residue_96 + modulus * (sparse [1, 2, 3, 8, 10, 16, 20, 22, 24, 26, 28, 38, 50, 52, 54, 56, 60, 64, 74, 78, 84, 90, 96, 104, 106, 116, 118, 122, 124]) := by
  unfold residue_95 residue_96 modulus
