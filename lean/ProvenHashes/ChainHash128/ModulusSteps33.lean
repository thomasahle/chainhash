...
theorem residue_step_33 : residue_33 ^ 2 = residue_34 + modulus * (sparse [2, 3, 4, 5, 6, 16, 18, 24, 26, 32, 38, 40, 42, 46, 50, 52, 56, 58, 66, 74, 90, 96, 98, 108, 110, 114, 116, 118, 124, 126]) := by
