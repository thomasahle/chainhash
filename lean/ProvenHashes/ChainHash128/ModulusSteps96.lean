...
theorem residue_step_96 : residue_96 ^ 2 = residue_97 + modulus * (sparse [2, 3, 6, 12, 14, 22, 24, 30, 34, 36, 48, 52, 60, 64, 76, 78, 80, 82, 84, 86, 88, 92, 94, 98, 106, 108, 110, 124]) := by
  unfold residue_96 residue_97 modulus
