...
theorem residue_step_45 : residue_45 ^ 2 = residue_46 + modulus * (sparse [1, 2, 3, 6, 10, 12, 18, 20, 32, 34, 38, 40, 44, 48, 50, 52, 60, 62, 64, 66, 68, 70, 72, 76, 80, 84, 94, 96, 98, 102, 104, 106, 108, 110, 116, 122, 124]) := by
