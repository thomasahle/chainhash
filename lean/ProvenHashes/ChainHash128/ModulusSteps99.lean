...
theorem residue_step_99 : residue_99 ^ 2 = residue_100 + modulus * (sparse [0, 1, 2, 4, 5, 8, 12, 14, 18, 20, 24, 26, 30, 34, 38, 40, 42, 46, 50, 52, 54, 56, 58, 64, 68, 72, 78, 86, 94, 96, 102, 104, 106, 108, 110, 114, 122, 126]) := by
  unfold residue_99 residue_100 modulus
