...
theorem residue_step_74 : residue_74 ^ 2 = residue_75 + modulus * (sparse [1, 3, 4, 5, 6, 8, 10, 14, 16, 30, 32, 36, 38, 40, 46, 50, 68, 70, 72, 74, 76, 84, 96, 98, 102, 108, 112, 114, 118, 120, 122, 124, 126]) := by
  unfold residue_74 residue_75 modulus
