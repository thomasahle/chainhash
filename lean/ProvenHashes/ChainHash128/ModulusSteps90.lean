...
theorem residue_step_90 : residue_90 ^ 2 = residue_91 + modulus * (sparse [1, 4, 5, 6, 8, 12, 14, 16, 18, 28, 30, 32, 34, 38, 44, 48, 54, 62, 64, 66, 68, 76, 80, 82, 84, 90, 94, 96, 100, 102, 106, 110, 112, 114, 118, 120, 122, 126]) := by
  unfold residue_90 residue_91 modulus
