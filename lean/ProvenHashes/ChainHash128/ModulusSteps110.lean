...
theorem residue_step_110 : residue_110 ^ 2 = residue_111 + modulus * (sparse [1, 6, 14, 20, 22, 24, 28, 34, 40, 46, 48, 52, 62, 66, 68, 72, 76, 82, 86, 88, 90, 92, 98, 102, 112, 118, 120, 122]) := by
  unfold residue_110 residue_111 modulus
