...
theorem residue_step_80 : residue_80 ^ 2 = residue_81 + modulus * (sparse [0, 1, 2, 3, 4, 8, 10, 12, 16, 22, 26, 30, 36, 38, 40, 44, 46, 52, 56, 58, 62, 66, 72, 74, 80, 84, 88, 92, 94, 96, 98, 106, 110, 112, 118, 120, 122, 124]) := by
  unfold residue_80 residue_81 modulus
