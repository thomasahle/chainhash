...
theorem residue_step_24 : residue_24 ^ 2 = residue_25 + modulus * (sparse [3, 4, 5, 6, 12, 16, 26, 28, 32, 36, 38, 42, 46, 50, 52, 56, 60, 64, 66, 68, 72, 84, 90, 94, 102, 104, 106, 108, 110, 112, 114, 116, 124, 126]) := by
