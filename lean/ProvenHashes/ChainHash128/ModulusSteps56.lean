...
theorem residue_step_56 : residue_56 ^ 2 = residue_57 + modulus * (sparse [0, 1, 2, 3, 8, 14, 16, 20, 22, 24, 26, 30, 36, 40, 42, 52, 56, 60, 64, 66, 76, 82, 88, 92, 98, 116, 120, 122, 124]) := by
