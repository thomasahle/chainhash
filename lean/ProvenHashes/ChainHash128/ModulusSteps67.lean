...
theorem residue_step_67 : residue_67 ^ 2 = residue_68 + modulus * (sparse [1, 2, 3, 4, 5, 6, 8, 10, 12, 14, 18, 20, 22, 30, 32, 34, 36, 38, 40, 42, 46, 52, 56, 60, 62, 70, 74, 78, 80, 84, 86, 90, 94, 96, 100, 106, 112, 114, 122, 124, 126]) := by
  unfold residue_67 residue_68 modulus
