# ChainHash v1 — the paper's function

This is the preserved v1 user guide. For ChainHash-Horner v3, see the
[current README](../README.md). All keys, bounds and Lean claims below are v1.
